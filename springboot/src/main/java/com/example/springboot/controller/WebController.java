...
public class WebController {
    ...
    public ResponseEntity<byte[]> handleFrontendRoutes(HttpServletRequest request) throws IOException {
        ...
        if (requestPath.contains("/api/") || requestPath.contains("/admin/") || requestPath.contains("/teams/") || requestPath.contains("/iteration/") || requestPath.contains("/dashboard/") || requestPath.startsWith("/workbench/tasks")) {
