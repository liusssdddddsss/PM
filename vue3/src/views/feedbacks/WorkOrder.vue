...
<!--&lt;!&ndash;            <el-button type="primary" size="small">导入</el-button>&ndash;&gt;-->
<!--          </div>-->
<!--        </div>-->

<!--&lt;!&ndash;        <div class="workorder-list">&ndash;&gt;-->
<!--&lt;!&ndash;          <el-table&ndash;&gt;-->
<!--&lt;!&ndash;              :data="workorderList"&ndash;&gt;-->
...
<!--&lt;!&ndash;            <el-table-column prop="title" label="标题" min-width="300"></el-table-column>&ndash;&gt;-->
<!--&lt;!&ndash;            <el-table-column prop="priority" label="P" width="40" align="center">&ndash;&gt;-->
<!--&lt;!&ndash;              <template #default="scope">&ndash;&gt;-->
<!--&lt;!&ndash;                <el-tag size="small" :type="getPriorityType(scope.row.priority)">&ndash;&gt;-->
<!--&lt;!&ndash;                  {{ scope.row.priority }}&ndash;&gt;-->
<!--&lt;!&ndash;                </el-tag>&ndash;&gt;-->
<!--&lt;!&ndash;              </template>&ndash;&gt;-->
<!--&lt;!&ndash;            </el-table-column>&ndash;&gt;-->
<!--&lt;!&ndash;            <el-table-column prop="source" label="来源" width="100"></el-table-column>&ndash;&gt;-->
<!--&lt;!&ndash;            <el-table-column prop="status" label="状态" width="100"></el-table-column>&ndash;&gt;-->
<!--&lt;!&ndash;            <el-table-column prop="type" label="类型" width="100"></el-table-column>&ndash;&gt;-->
<!--&lt;!&ndash;            <el-table-column label="操作" width="150" fixed="right">&ndash;&gt;-->
<!--&lt;!&ndash;              <template #default="scope">&ndash;&gt;-->
<!--&lt;!&ndash;                <el-button size="small" @click="viewDetail(scope.row)">查看</el-button>&ndash;&gt;-->
<!--&lt;!&ndash;                <el-button size="small" @click="editWorkorder(scope.row)">编辑</el-button>&ndash;&gt;-->
<!--&lt;!&ndash;                <el-button size="small" @click="assignWorkorder(scope.row)">指派</el-button>&ndash;&gt;-->
<!--&lt;!&ndash;                <el-button size="small" @click="moreActions(scope.row)">更多</el-button>&ndash;&gt;-->
<!--&lt;!&ndash;              </template>&ndash;&gt;-->
<!--&lt;!&ndash;            </el-table-column>&ndash;&gt;-->
<!--&lt;!&ndash;          </el-table>&ndash;&gt;-->
<!--        <TaskList/>-->
